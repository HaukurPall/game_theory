...
\usepackage{bm}
\usepackage{graphicx}
%\graphicspath{ {/home/sh/Desktop/CSC/CSC_HW/miniproject/} }
...
Figures ... show the frequencies of manipulable profiles for $100$ profiles between $10$ and $1000$ voters.
\subsection{Descriptive Analysis}
%\includegraphics[scale=•]{6candidates}
