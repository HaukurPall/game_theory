...
This function has a maximal when $n_{r_1}^{\boldsymbol{a}}=99$ and $n_{r_1}^{\boldsymbol{a}}=100$ with $P(\boldsymbol{a})=-1661.4629471031476$, only considering whole number solutions. Thus those are the Pure Nash equilibrium.
